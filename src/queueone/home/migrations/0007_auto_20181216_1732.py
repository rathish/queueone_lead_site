# Generated by Django 2.0.6 on 2018-12-16 17:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0006_auto_20181216_1716'),
    ]

    operations = [
        migrations.CreateModel(
            name='QueueWorkTimeline',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.Page')),
                ('content', models.CharField(max_length=255)),
                ('timeline_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image')),
            ],
            options={
                'abstract': False,
            },
